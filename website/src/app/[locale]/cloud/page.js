...
const features = [
  ...
  },
  {
    ...
    body: 'AI provider API keys are stored only on your VM — never sent to ThriveTech. Your code never leaves your machine or your server.',
  },
  {
    icon: <Storage />,
...
export default async function MahalaxmiCloudPage({ params }) {
    ...
    <Box>
      ...
      <Box sx={{ bgcolor: 'grey.50', py: { xs: 6, md: 10 } }}>
        <Container maxWidth="md">
          ...
          <Paper elevation={2}><TableContainer>
            <Table>
              <TableHead>
        ...
        <Container maxWidth="lg">
          ...
          {pricingData ? (
            ...
            >
              ...
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center', flexWrap: 'wrap' }}>
                <Button component="a" href="/support" variant="contained" endIcon={<ArrowForward />}>
                  Contact Support
                </Button>
          ...
          <Box sx={{ textAlign: 'center', mt: 3 }}>
            <Button component="a" href="/cloud/pricing" endIcon={<ArrowForward />} variant="text">
        ...
        <Container maxWidth="sm">
          <Paper elevation={0} variant="outlined" sx={{ p: 4, borderLeft: '4px solid', borderColor: 'primary.main', borderRadius: '0 8px 8px 0' }}>
            ...
            <Typography variant="body2" color="text.secondary">
              Your source code stays on your machine. AI provider API calls go directly from your VM to your provider&apos;s endpoint — ThriveTech never proxies, receives, or stores your prompts, completions, or code. The only data ThriveTech receives is a license token and machine fingerprint for validation.
            </Typography>
          </Paper>
        </Container>
      </Box>
